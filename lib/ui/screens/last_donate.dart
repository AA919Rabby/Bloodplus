...
class LastDonate extends StatelessWidget {
  LastDonate({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Last Donate',style: GoogleFonts.poppins(
       ...
       body: Padding(
         ...
         child: Expanded(
           child: StreamBuilder<QuerySnapshot>(stream: authController.userDonate(),
               builder: (context,snapshot){
                 ...
                 if(!snapshot.hasData || snapshot.data!.docs.isEmpty){
                   return Center(child: Text(
                     "You haven't donate",style: GoogleFonts.poppins(
