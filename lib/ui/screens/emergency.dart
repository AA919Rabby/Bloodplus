  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Emergency',style: GoogleFonts.poppins(
      ...
      body: Padding(
        ...
        child: Form(
          key: authController.requestBloodKey,
          child: Column(
            ...
            children: [
              CustomAuth(
                ...
                controller: authController.requestUsernameController,
              ...
              CustomAuth(
                ...
                controller: authController.requestPhoneController,
              ...
              CustomAuth(
                ...
                controller: authController.requestLocationController,
              ...
              Row(
                children: [
                  Expanded(child: Obx(()=>BloodAuth(
                    ...
                    controller: authController.requestCityController,
                    ...
                    suffixIcon: DropdownButtonHideUnderline(
                      child: DropdownButton(
                          ...
                          onChanged: (value){
                            authController.requestCityAdd(value.toString());
                          }),
                    ),
                    readOnly: true,
                    hintText: authController.requestCity.value.isEmpty?
                    'City':authController.requestCity.value,
                  ))),
                  ...
                  Expanded(child: BloodAuth(
                    ...
                    controller: authController.requestAgeController,
                    hintText: 'Age',
              ...
              Row(
                children: [
                  Expanded(child: Obx(()=>BloodAuth(
                    ...
                    controller: authController.requestBloodController,
                    ...
                    suffixIcon: DropdownButtonHideUnderline(
                      child: DropdownButton(
                          ...
                          onChanged: (value){
                            authController.requestBloodRequest(value.toString());
                          }),
                    ),
                    readOnly: true,
                    hintText: authController.requestBloodGroup.value.isEmpty?
                    'Blood type':authController.requestBloodGroup.value,
                  ))),
                  SizedBox(width: size.height*.02,),
                  Expanded(child: BloodAuth(
                    validator: (value){
                    ...
                    controller: authController.requestWeightController,
                    hintText: 'Weight',
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                      onTap: (){
                        authController.requestDecrease();
                      },
                      child: Icon(Icons.delete,color: AllThemes.red,size: size.height*.025,)),
                  SizedBox(width: size.height*.01,),
                  Obx(()=>Text('  ${authController.requestAmount.value} Bag  ',style: GoogleFonts.poppins(
                    fontSize:size.height*.023,
                    fontWeight: FontWeight.w500,
                    color: AllThemes.lightText,
                  ),),),
                  ...
                  GestureDetector(
                      onTap: (){
                        authController.requestIncrease();
                      },
              ...
              Obx(()=> authController.isLoading.value?Center(
                ...
                onTap: (){
                  if(authController.requestBloodKey.currentState!.validate()){
                    authController.emergencyBlood();
                  }
                },
                color: AllThemes.red, label: 'Request',labelColor: AllThemes.lightBg,),),
