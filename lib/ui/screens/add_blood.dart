...
class AddBlood extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Donators',style: GoogleFonts.poppins(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text('Recently Donate',style: GoogleFonts.poppins(
                    ...
                    Hero(
                      ...
                      child: Material(
                        ...
                        child: GestureDetector(
                          onTap: (){
                            Get.to(()=>AddDonate(),duration: Duration(milliseconds: 800),
                          ...
                          child: Container(
                              ...
                              child: Center(child: Icon(Icons.add,color: AllThemes.lightBg,
            ...
            Expanded(
              child: StreamBuilder(
                  stream: authController.getDonor(),
                  builder: (context,snapshot){
                    ...
                    if(!snapshot.hasData || snapshot.data!.docs.isEmpty){
                      return Center(child: Text(
                        'No Donor Request',style: GoogleFonts.poppins(
  ...
  //Check need blood or donate blood
checkRequest(){
